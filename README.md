...
The 2020 stock price data of Microsoft has been used to predict the probability of gain/drop for interested investors.                                      Key tools: Statistical Modeling, normal distribution, KDE (PDF) plots 
